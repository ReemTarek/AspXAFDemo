...
namespace TestXafDemo.Module {
    // For more typical usage scenarios, be sure to check out https://docs.devexpress.com/eXpressAppFramework/DevExpress.ExpressApp.ModuleBase.
    public sealed partial class TestXafDemoModule : ModuleBase {
        static TestXafDemoModule() {
            ...
            // #if DEBUG
            // Database.SetInitializer(new DropCreateDatabaseIfModelChanges<TestXafDemoDbContext>());
            // #endif 
        }
        public TestXafDemoModule() {
            InitializeComponent();
        }
